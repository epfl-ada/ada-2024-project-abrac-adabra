...
def test_generate_interactive_ic50_plot():
    ...
    fig = make_subplots(rows=2, cols=1, shared_xaxes=True, shared_yaxes=True, x_title='Amino acid position', y_title='IC50 Log Ratio')
    ...
    fig.update_layout(coloraxis=dict(
            ...
            colorbar=dict(len=0.35, y=0.2, title=dict(
                text="Difference in ESM2 Probability",
                side="right"  # Position of the title relative to the color bar
            ))
        ))
